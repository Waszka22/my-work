# Labs
# Week 03
#Create a file called testTypes.py, in the file create 5 variables one for each of
#the following types: int, float, boolean, str, list (look at w3schools.com)
#Use the type() function to check that the variables are of that type. Your
